...
/** Этот класс является подклассом FractalGenerator. Он используется для построения
...
public class Mandelbrot extends FractalGenerator
{
    ...
    /** Метод позволяет генератору фракталов определить наиболее «интересную» область
     комплексной плоскости для конкретного фрактала. Методу в качестве
     ...
     фрактала. Этот метод должен установить начальный диапазон в (-2 - 1.5i) - (1 + 1.5i).
    ...
    /**Константа с максимальным кол-вом операций*/
    public static final int MAX_ITERATIONS = 2000;

    /**Этот метод реализует итеративную функцию для фрактала Мандельброта (для комплексных чисел)
     */
